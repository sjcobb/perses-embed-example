  ...
  return (
    <div className="max-w-[512px] mx-auto p-10 bg-white rounded-lg">
      ...
      <p className="pb-5 text-lg">
        <strong>Inpainting</strong> is a process where missing parts of an artwork are filled in to present a complete
        image. This{' '}
        <a className="underline" href="https://github.com/zeke/inpainter">
          open-source demo
        </a>{' '}
        uses the{' '}
        <a className="underline" href="https://replicate.com/stability-ai/stable-diffusion">
          Stable Diffusion
        </a>{' '}
